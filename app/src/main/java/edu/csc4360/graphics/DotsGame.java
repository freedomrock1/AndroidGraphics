...
public class DotsGame {
    ...
    public static int INIT_MOVES = 10;

    public enum AddDotStatus { Added, Rejected, Removed };
    ...
    public AddDotStatus addSelectedDot(Dot dot) {
        AddDotStatus status = AddDotStatus.Rejected;
